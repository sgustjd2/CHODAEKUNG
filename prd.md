...
| 이름 | 영문 | 방향 |
|---|---|---|
| 모이레터 | MOI LETTER | 모임 + 편지, 가장 설명력이 좋음 |
...
1. **모이레터 (MOI LETTER)** — 기능 확장성과 브랜드 설명력이 가장 좋음
