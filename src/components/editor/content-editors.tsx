 ...
 */
export function ContentEditors({ draft, patch, selectedId }: { draft: Invitation; patch: (id: string, content: object) => void; selectedId?: string }) {
  ...
  return (
    <>
      ...
      {countdown && (
        <div className="insp-group">
          <h5>카운트다운</h5>
          <div style={{ fontSize: 11, color: "var(--fg-3, #8a8a99)", marginBottom: 8, lineHeight: 1.5 }}>
            남은 시간은 “내용” 탭 하단의 <b>행사 일시</b>를 기준으로 자동 계산돼요. 여기선 단위 라벨만 바꿔요.
          </div>
